...
| 文档版本 | 发布日期 | 修改说明 |
| :--- | :--- | :--- |
| 01 | 2026-09-30 | 第一次正式发布。<br>- 统一llama.cpp相关描述为官方llama.cpp（commit `3ac67535c86`）。<br>- 处理器名称统一为鲲鹏950处理器/鲲鹏920新型号处理器。<br>- 将分块策略、推理流程与调用链等改为有序列表文字描述。<br>- 修正与Markdown链接冲突的方括号表达式，并将特殊箭头符号替换为`-&gt;`。 |
